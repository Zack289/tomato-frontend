  ...
  return (
    <div className="mx-auto max-w-5xl px-4 py-6 space-y-6">
          ...
          return (
            ...
            >
              ...
              <div className="flex items-center gap-3">
                <button
                  className="rounded-full border p-2 hover:bg-gray-100 disabled:opacity-50 cursor-pointer"
                  disabled={isLoading}
      ...
      <div className="rounded-xl bg-white p-4 shadow-sm space-y-3">
        ...
        <button
          className="mt-3 w-full rounded-lg bg-[#2d2929] py-3 text-sm font-semibold text-white hover:bg-gray-900 cursor-pointer flex justify-center items-center gap-3"
          onClick={clearCart}
