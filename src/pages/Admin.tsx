    ...
    <div className="mx-auto max-w-6xl px-6 py-6 space-y-6">
      ...
      <div className="flex gap-4">
        <button
          ...
          className={`px-4 py-2 cursor-pointer rounded ${tab === "restaurant" ? "bg-red-500 text-white" : "bg-gray-200 text-black"}`}
        >
          Restaurants
        </button>
        ...
        <button
          ...
          className={`px-4 py-2 rounded cursor-pointer ${tab === "rider" ? "bg-red-500 text-white" : "bg-gray-200 text-black"}`}
        >
          Riders
        </button>
      </div>
